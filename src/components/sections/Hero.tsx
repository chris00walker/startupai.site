...
export function Hero() {
  ...
  return (
    <section className="business-gradient text-foreground py-16 md:py-24 relative overflow-hidden tech-grid">
      ...
      <div
        className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-br from-primary/10 to-primary/5 rounded-full floating-element shadow-lg"
        style={{ animationDelay: '2s' }}
      ></div>
      <div
        className="absolute bottom-32 left-1/4 w-12 h-12 border border-primary/15 rotate-45 floating-element backdrop-blur-sm"
        style={{ animationDelay: '4s' }}
      ></div>
      <div
        className="absolute top-1/3 right-1/3 w-24 h-24 bg-gradient-to-tr from-primary/5 to-transparent rounded-full blur-xl floating-element"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            We build your MVP, test it with real customers, and tell you if your
            idea works—or how to pivot. Join our private beta.
          </p>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
            {[
              ...
              const isOtherHovered =
                hoveredFeature !== null && hoveredFeature !== feature.index;
              ...
              return (
                ...
                >
                  {IconComponent && (
                    <IconComponent
                      className={`h-4 w-4 text-primary mr-2 transition-all duration-300 ${
