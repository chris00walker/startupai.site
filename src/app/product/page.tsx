  ...
  const features = [
    {
      ...
      description:
        'Multi-agent AI system for generating professional business canvases and strategic frameworks.',
      badge: 'AI Innovation',
      href: '/demo',
      cta: 'Try Demo',
    },
    {
      ...
      description:
        'Custom multi-agent AI systems that automate complex business processes and decision-making workflows.',
      badge: 'AI Automation',
    ...
    },
    {
      ...
      description:
        'AI-powered analytics that provide real-time insights into startup metrics, growth patterns, and market opportunities.',
      badge: 'AI Analytics',
    ...
    },
    {
      ...
      description:
        'End-to-end development of scalable digital platforms optimized for startup growth and market validation.',
        ...
        <PageContainer variant="wide" padding="lg">
          <PageHeader variant="centered" className="mb-8">
            ...
            <PageDescription className="text-xl max-w-2xl mx-auto">
              From Ai-powered strategy development to digital platform
              optimization, discover the cutting-edge multi-agent Ai workflows
              we've built to drive your startup' success.
            </PageDescription>
          </PageHeader>
        </PageContainer>
      </section>
        ...
        <PageContainer variant="wide" padding="lg">
          <PageHeader variant="centered" className="mb-12">
            ...
            <PageDescription className="max-w-2xl mx-auto">
              Real pain points and struggles from entrepreneurs seeking better
              strategy tools.
            </PageDescription>
          </PageHeader>
          <div className="grid md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground italic">
                  ...
                  them. I need guided idea validation."
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground italic">
                  "ChatGPT business plans are too generic - you could swap 'pet
                  portraiture' with half a million other products and it would
                  still sound good."
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground italic">
                  "Market research and experimentation is time-consuming and
                  difficult to do alone. I struggle without guidance."
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-muted-foreground mb-6 leading-relaxed">
                    A revolutionary multi-agent AI system that generates
                    professional business canvases, validates strategic ideas,
                    and accelerates consulting workflows. Built with
                    cutting-edge AI technology and proven startup framework
                    methodologies.
                  </p>
                  <div className="bg-primary/10 p-6 rounded-lg mb-6 border border-primary/30 backdrop-blur-sm">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Get instant access to our live AI demo and see how
                      multi-agent systems can transform your business strategy
                      development.
                    </p>
                  </div>
                </div>
          ...
          <Card className="bg-gradient-to-r from-primary/10 to-primary/5 border-primary/20">
            <CardContent className="text-center py-12">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join successful startups that have accelerated their growth with
                our multi-agent AI solutions. Start with a free consultation.
              </p>
            </CardContent>
          </Card>
        </PageContainer>
