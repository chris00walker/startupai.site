                ...
                <div key={workflow.id} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{workflow.agent}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Generate customer-focused value propositions</p>
            </CardContent>
          </Card>
          ...
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Create comprehensive business models</p>
            </CardContent>
          </Card>
          ...
          <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">Validate concepts with structured experiments</p>
            </CardContent>
          </Card>
        </div>
      </div>
