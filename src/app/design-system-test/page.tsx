    ...
    <div className="page-container-centered">
      ...
      <div className="page-header-title-with-actions">
        <div className="page-header-text">
          ...
          <p className="text-muted-foreground">Component Standardization Showcase</p>
        </div>
      ...
      <section className="space-section">
        ...
        <div className="block-layout">
          ...
          <div className="layout-flex">
            ...
            <button className="btn-default btn-primary btn-loading">Loading</button>
            <button className="btn-default btn-primary btn-disabled" disabled>Disabled</button>
          </div>
        </div>
      </section>
      ...
      <section className="space-section">
        ...
        <div className="card-grid-3">
          ...
          <div className="card-base">
            <div className="card-header">
              ...
              <p className="card-description">Standard card with minimal styling</p>
            </div>
            <div className="card-content">
              <p>This is a basic card component with standard padding and shadow.</p>
            </div>
          ...
          <div className="card-interactive">
            <div className="card-header">
              ...
              <p className="card-description">Clickable card with hover effects</p>
            </div>
            <div className="card-content">
              <p>This card responds to user interaction with scale and shadow changes.</p>
            </div>
          </div>
        </div>
        ...
        <div className="card-grid-2 mt-6">
          ...
          <div className="card-feature">
            ...
            <div className="content-feature-text">
              ...
              <p className="text-muted-foreground">Highlighted card with accent bar and icon</p>
            </div>
          </div>
          ...
          <div className="card-metric">
            ...
            <span className="card-metric-change text-green-600">+12.5% from last month</span>
          </div>
        </div>
        ...
        <div className="mt-6">
          <div className="card-glass card-lg">
            ...
            <p className="text-muted-foreground">This card uses glass morphism effects with backdrop blur and transparency.</p>
          </div>
        </div>
      </section>
        ...
        <div className="block-layout mt-6">
          ...
          <div className="content-split">
            <div>
              ...
              <p className="text-muted-foreground">Perfect for side-by-side content presentation with automatic responsive behavior.</p>
            </div>
