  ...
  return (
    <div className="min-h-screen business-gradient tech-grid">
      ...
      <>
        ...
        <div
          className="absolute top-52 right-16 w-14 h-14 bg-primary/5 rounded-full floating-element"
          style={{ animationDelay: '2.5s' }}
        ></div>
        <div
          className="absolute bottom-44 right-2/5 w-6 h-6 border border-primary/15 rotate-45 floating-element"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Improve existing systems and processes to maximize efficiency,
            ...
            <Card className="business-card mb-8 glow-effect hover:scale-[1.02] transition-all duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  opportunities for improvement. Through systematic
                  optimization, we help you achieve better performance and user
                  satisfaction. Our data-driven approach ensures measurable
