...
export const metadata: Metadata = {
  title: 'Scaling Services | StartupAI',
  description:
  ...
  return (
    <div className="min-h-screen business-gradient tech-grid">
      ...
      >
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Scaling</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </PageContainer>
      ...
      <>
        ...
        <div
          className="absolute top-60 left-8 w-6 h-6 bg-primary/5 rounded-full floating-element"
          style={{ animationDelay: '4s' }}
        ></div>
        <div
          className="absolute bottom-36 right-1/5 w-8 h-8 border border-primary/15 rotate-45 floating-element"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Build robust systems and processes that support sustainable
            ...
            <Card className="business-card mb-8 glow-effect hover:scale-[1.02] transition-all duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  Scaling requires careful planning and execution. We help you
                  build systems that can handle increased load while maintaining
                  quality and efficiency across all aspects of your business.
                  Our systematic approach ensures sustainable growth without
