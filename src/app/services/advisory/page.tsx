          ...
          <div className="text-center max-w-5xl mx-auto">
            ...
            <PageHeader variant="centered">
              ...
              <PageDescription className="business-subtitle text-xl max-w-3xl mx-auto">
                Transform your startup with evidence-based AI strategy sprints.
                Get from idea to validated business model in days, not
                months—with comprehensive market validation and technical
                architecture.
              </PageDescription>
            </PageHeader>
          </div>
                ...
                <div className="space-y-3">
                  <div className="p-4 rounded-lg bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800">
                    <p className="text-sm font-medium flex items-center gap-2">
                      ...
                      Why we're 80% cheaper: Multi-agent AI orchestration
                      automates research & validation
                    </p>
                  </div>
                  <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
                    <p className="text-sm font-medium flex items-center gap-2">
                      <Shield className="w-4 h-4 text-blue-600" />
                      Evidence-based outputs: Every recommendation backed by
                  ...
                  <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800">
                    <p className="text-sm font-medium flex items-center gap-2">
                      ...
                      Production-ready architecture: Domain models & APIs
                      generated alongside strategy
                    </p>
                  </div>
                  <div className="p-4 rounded-lg bg-orange-50 dark:bg-orange-950/20 border border-orange-200 dark:border-orange-800">
                    <p className="text-sm font-medium flex items-center gap-2">
                      <Target className="w-4 h-4 text-orange-600" />
                      Validated demand scoring: 82.6% accuracy using weighted
                      criteria & real user feedback
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium">
                      Share Your Idea (Private & Secure)
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Your IP is protected with enterprise-grade privacy
                      controls
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Multi-agent orchestration finds real market data &
                      evidence
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-medium">
                      Generate Strategy & Architecture
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Get BMC, Value Proposition, and DDD technical design
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Ongoing refinement based on feedback and market changes
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            {[
              ...
              const isOtherHovered =
                hoveredCard !== null && hoveredCard !== stat.index;
              ...
              return (
                ...
                >
                  <IconComponent
                    className={`w-8 h-8 text-primary mx-auto mb-2 transition-all duration-300 ${
          ...
          <div className="text-center">
            <div className="mb-4">
              ...
              <p className="text-lg font-semibold">
                Transform your idea into a validated strategy in 1 week
              </p>
            </div>
