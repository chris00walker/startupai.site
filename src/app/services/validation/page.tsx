...
export const metadata: Metadata = {
  title: 'Validation Services | Chris Walker Consulting',
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <Badge variant="secondary" className="glow-effect">Validation Phase</Badge>
              </div>
            ...
            <Card className="business-card mb-8 glow-effect hover:scale-[1.02] transition-all duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed">
                  We build minimal viable products to test core assumptions with real users. 
                  Through systematic testing and data collection, we validate or pivot 
                  your approach based on actual market feedback. Our iterative process 
                  ensures rapid learning and continuous improvement of your product-market fit.
                </p>
              </CardContent>
            </Card>
