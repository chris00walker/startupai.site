  ...
  strategy: [
    {
      ...
      description:
        'AI-powered market validation and strategy development with evidence traceability.',
      features: [
        '40+ competitor analysis',
        'Evidence-backed BMC & VPC',
    ...
    },
    {
      ...
      description:
        'Continuous AI-powered strategic guidance with private-by-design architecture.',
      features: [
        'Real-time strategy iteration',
  ...
  development: [
    {
      ...
      badge: '100% Traceable',
      description:
        'Test assumptions with AI-analyzed market data before writing code.',
      features: [
    ...
    },
    {
      ...
      description:
        'From validated idea to production architecture with AI-generated code scaffolding.',
      features: [
        'DDD to code generation',
        'API contract design',
  ...
  optimization: [
    {
      ...
      description:
        'AI-driven optimization of strategy, architecture, and market positioning.',
      features: [
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              From idea validation to production deployment, our AI-powered
              services deliver evidence-backed strategies and architectures in
              days, not months.
            </p>
              ...
              <TabsContent value="strategy" className="mt-8">
                <div className="grid md:grid-cols-2 gap-6">
                  {serviceCategories.strategy.map((service) => (
                    <Card
                      key={service.name}
                      className="hover:shadow-lg transition-all duration-300 hover:scale-[1.02] hover:border-primary/20 flex flex-col h-full"
                    >
                      <CardHeader>
